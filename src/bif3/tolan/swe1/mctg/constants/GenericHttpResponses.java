...
/**
 * Collection of static HTTP responses that get used throughout the API
 *
 * @author Christopher Tolan
 */
public final class GenericHttpResponses {
    public final static String DEFAULT_JSON_FORMAT = "{\"Message\":\"%s\"}";
    public final static HttpResponse INTERNAL_ERROR = new HttpResponse(HttpStatus.INTERNAL_SERVER_ERROR, HttpContentType.JSON, String.format(DEFAULT_JSON_FORMAT, "An issue occurred on server side. Please contact the support for further instructions."));
    ...
    public final static HttpResponse SUCCESS_BUY = new HttpResponse(HttpStatus.OK, HttpContentType.JSON, String.format(DEFAULT_JSON_FORMAT, "Purchase successfully!"));
    ...
    public final static HttpResponse TRADE_CRITERIA_NOT_MET = new HttpResponse(HttpStatus.NOT_ACCEPTABLE, HttpContentType.JSON, String.format(DEFAULT_JSON_FORMAT, "Your card does not meet the trade criteria. Please try with a different card."));
    ...
    public final static HttpResponse SUCCESS_CREATE = new HttpResponse(HttpStatus.CREATED, HttpContentType.JSON, String.format(DEFAULT_JSON_FORMAT, "Successfully created!"));
}
