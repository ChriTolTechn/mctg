...
import bif3.tolan.swe1.mctg.model.Battle;
...
import bif3.tolan.swe1.mctg.utils.EloUtils;
...
/**
 * Implementation of Workable responsible for battles
 *
...
public class BattleWorker implements Workable {
    ...
    private HttpResponse battle(HttpRequest request) {
        ...
        try {
            ...
            // get all the cards of the users deck and assign to user
            requestingUser.setDeck(cardRepository.getAllCardsByDeckIdAsMap(deckIdOfRequestingUser));

            // check deck validity of the deck
